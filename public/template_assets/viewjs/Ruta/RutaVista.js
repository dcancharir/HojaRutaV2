                ...
                success: function (response) {
                    if(response.respuesta){
                        ...
                        $(addTable).append(`<div class="card">
                                                <div class="card-body">
                                                    <table id="datatableRuta" class="table table-xs table-hover" style="width:100%">
                                                        <tbody></tbody>
                                                    </table>
                                                </div>
                                            </div>`);
...
function format ( data ) {
    ...
    let template=`<div class="table-responsive">
                    <table class="table text-nowrap table-xs table-striped table-bordered" id="tableDetalleRuta">
                        <thead>
                            <tr>
                                <th>Orden</th>
                                <th>Tienda</th>
