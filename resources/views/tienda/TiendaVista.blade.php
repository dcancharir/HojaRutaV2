...
<div class="content">
	...
	<div class="card">
		<div class="card-body">
			<table class="datatable-tienda table table-xs text-nowrap table-hover" style="width:100%">
...
@push('js')
<script src="{{asset('/template_assets/viewjs/Tienda/TiendaVista.js')}}"></script>
@endpush
